...
<head>
  ...
  <title>PSB SMA NEGRI 1 SERUI</title>
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      <h1 class="logo me-auto"><a href="index.html">SMA NEGRI 1 SERUI</a></h1>
      <nav id="navbar" class="navbar">
        <ul>
          <li class="{{ Request::path() === '/' ? 'active' : '' }}">
            <a href="{{ route ('siswa.dashboard') }}">Home</a></li>
          <li class="{{ Request::path() === '/' ? 'active' : '' }}">
            <a href="{{ route ('siswa.pendaftaran') }}">Pendaftaran</a></li>
          <li class="{{ Request::path() === '/' ? 'active' : '' }}">
            <a href="{{ route ('siswa.pengumuman') }}">Pengumuman</a></li>
          <li class="{{ Request::path() === '/' ? 'active' : '' }}">
            <a href="{{ route ('siswa.kontak') }}">Kontak</a></li>
          <li class="{{ Request::path() === '/' ? 'active' : '' }}">
            <a href="{{ route ('siswa.profil') }}">Profil</a></li>
