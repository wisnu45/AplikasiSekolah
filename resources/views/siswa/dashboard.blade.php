...
<section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url({{ asset('user') }}/img/slide/upacarasmsn1serui.jpg)">
        ...
        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url({{ asset('user') }}/img/slide/hiburansman1serui.jpg)">
          <div class="carousel-container">
            <div class="container">
        ...
        <!-- Slide 3 -->
        <div class="carousel-item" style="background-image: url({{ asset('user') }}/img/slide/sman1serui.jpg)">
          <div class="carousel-container">
            <div class="container">
        ...
        <!-- Slide 4 -->
        <div class="carousel-item" style="background-image: url({{ asset('user') }}/img/slide/pamplatesman1serui.jpg)">
    <div class="carousel-container">
      <div class="container">
        <!-- <h2 class="animate__animated animate__fadeInDown">Sequi ea ut et est quaerat</h2>
        <p class="animate__animated animate__fadeInUp">Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et est quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut. Similique ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et tempore modi architecto.</p>
