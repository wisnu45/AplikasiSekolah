                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form  action="{{ route('admin.berita.update',['id' => $berita->id]) }}" method="POST"  enctype="multipart/form-data">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Kategori Berita<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='optional' name="kategoriberita_id" data-validate-length-range="5,15" type="text" value="{{ $berita->kategoriberita_id }}" /></div>
                                        </div>
