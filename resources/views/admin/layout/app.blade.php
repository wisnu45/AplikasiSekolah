...
<html lang="en">
  ...
  <body class="nav-md">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a  href="{{ route ('admin.dashboard') }}" class="site_title"></i> <span>Admin PSB</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="{{ asset('adminassets') }}/images/admin.png" alt="{{ asset('adminassets') }}." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="{{ route ('admin.dashboard') }}"><i class="fa fa-home"></i>Home<span class="#"></span></a>
                  ...
                  <li>
                  <li><a> <i class="fa fa-desktop"></i>Data Berita <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{ asset('adminassets') }}/images/admin.png" alt="">Admin
                  </a>
   ...
   <!-- start of weather widget -->
        ...
        <footer>
          <center>
            Copyright © <a href="https://smansasri.sch.id">SMA NEGRI 1 SERUI</a>
          </center>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
